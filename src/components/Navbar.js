        ...
        <React.Fragment>
            ...
            <nav className="flex items-center justify-between flex-wrap  p-3 mx-10  top-0 left-0 right-0">
                ...
                <div className='flex text-l text-gray-500'>
                    ...
                    <Link to="create"><h1 className='mr-6'>CREATE & MINT NFT</h1></Link>
                    <Link to="my-listed-items"><h1 className='mr-6'>YOUR LISTED NFTs</h1></Link>
                    <Link to="my-purchases"><h1 className='mr-6'>YOUR PURCHASED</h1></Link>
                </div>
                {
